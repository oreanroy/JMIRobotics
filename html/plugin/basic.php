...
<nav class="white-text z-depth-0 green" role="navigation">
    <div class="nav-wrapper container fixed">
      <a id="logo-container" href="#" class="brand-logo white-text"><b>JMI</b><span style="font-weight:lighter;font-size:+5"> Robotics&nbsp;</span></a>
    ...
    <div class="container">
      <div class="row">
        <div class="col l4 s12">
          <h5 class="white-text">JMI Robotics</h5>
        ...
        <div class="col l4 s12">
          ...
          <ul>
            <li><a class="white-text" href="http://twitter.com/roboconjmi"><i class="fa fa-twitter" aria-hidden="true"></i> @roboconjmi</a></li>
            <li><a class="white-text" href="http://facebook.com/roboconjmi"><i class="fa fa-facebook-official" aria-hidden="true"></i> @roboconjmi</a></li>
            <li><a class="white-text" href="http://instagram.com/roboconjmi"><i class="fa fa-instagram" aria-hidden="true"></i> @roboconjmi</a></li>
            <li><a class="white-text" href="http://youtube.com/roboconjmi"><i class="fa fa-youtube-play" aria-hidden="true"></i> @roboconjmi</a></li>
          </ul>
        </div>
      </div>
    </div>
...
function basic_decp($decp)
{
echo '
<meta name="description" content="'.$decp.'">
